...
namespace
{
    ...
    HoroExtensionStatus ImportAsset(
        ImporterState* importer, const HoroAssetImportRequest* request, HoroAssetImportResponse* response)
    {
        if (importer == nullptr || request == nullptr || response == nullptr ||
    ...
    HoroExtensionStatus GeneratePreview(
        ImporterState* /*importer*/, const HoroAssetPreviewRequest* request, HoroAssetPreviewResponse* response)
    {
    ...
    const HoroExtensionHostApi* host, HoroExtensionModuleApi* outModule)
{
    ...
    if (const HoroAssetImporterDescriptor descriptor{
            ...
            .importAsset = [](auto* context, const HoroAssetImportRequest* req, HoroAssetImportResponse* resp) {
                return ImportAsset(static_cast<ImporterState*>(context), req, resp);
            },
            .generatePreview = [](auto* context, const HoroAssetPreviewRequest* req, HoroAssetPreviewResponse* resp) {
                return GeneratePreview(static_cast<ImporterState*>(context), req, resp);
            },
            .destroyImporter = [](auto* context) {
