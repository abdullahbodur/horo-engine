...
class ProjectMigrationContext
{
  public:
    ...
    [[nodiscard]] Result<void> AddDocument(std::string projectRelativePath, MigrationDocumentKind kind,
...
class ProjectMigrationExecutor
{
  public:
    ...
    [[nodiscard]] static Result<PreparedProjectMigration> Prepare(
        ...
        const ProjectMigrationPlan& plan, JobSystem& jobs, ProjectMigrationLimits limits = {},
