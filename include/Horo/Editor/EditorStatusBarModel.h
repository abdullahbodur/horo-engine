...
namespace Horo::Editor {
    ...
    public:
         ...
         */
        [[nodiscard]] EditorStatusItemResult Register(EditorStatusItemDescriptor descriptor, EditorStatusItemContent content);
         ...
         */
        void CollectVisibleItems(const EditorStatusBarContext &context, std::vector<const EditorStatusItem *> &output) const;
     ...
     */
    [[nodiscard]] EditorStatusBarLayout PlanEditorStatusBarLayout(std::span<const EditorStatusMeasuredItem> measured, float availableWidth,
     ...
     */
    void PlanEditorStatusBarLayoutInto(std::span<const EditorStatusMeasuredItem> measured, float availableWidth, float itemGap,
                                       float overflowWidth, std::size_t maxVisibleItems,
