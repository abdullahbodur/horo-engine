...
class WorkspacePanelHost
{
  public:
    ...
    [[nodiscard]] WorkspaceLayout &Layout() noexcept { return m_layout; }
    [[nodiscard]] const WorkspaceLayout &Layout() const noexcept { return m_layout; }
    ...
    [[nodiscard]] WorkspaceLayoutOperationResult MovePanel(std::string_view panelId,
    ...
    [[nodiscard]] WorkspaceLayoutOperationResult SetActiveTab(std::string_view stackId,
                                                              std::string_view panelId);

    /** @brief Docks a panel into a tab stack or creates a split around a target node. */
    [[nodiscard]] WorkspaceLayoutOperationResult DockPanel(std::string_view panelId,
