...
public:
    ...
    /** @brief Renders the screen UI inside the application content area. */
    virtual void Draw() = 0;
...
public:
     ...
     */
    explicit GuiScreenHost(const EditorGuiContext& context,
     ...
     * @return Success or structured navigation error.
     */
