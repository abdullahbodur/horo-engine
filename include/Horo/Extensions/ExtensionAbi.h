...
typedef HoroExtensionStatus (*HoroAssetImportFunc)(
    void* importerContext, const HoroAssetImportRequest* request, HoroAssetImportResponse* response);
typedef HoroExtensionStatus (*HoroAssetPreviewFunc)(
...
typedef HoroExtensionStatus (*HoroRegisterAssetImporterFunc)(
 ...
 */
typedef HoroExtensionStatus (*HoroExtensionLoadFunc)(
