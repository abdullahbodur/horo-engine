...
namespace Horo::Extensions {
     ...
     */
    [[nodiscard]] Result<std::vector<ExtensionMarketplaceEntry>> ParseExtensionMarketplaceRegistry(std::string_view json,
    ...
    public:
         ...
         */
        ExtensionMarketplaceService(JobSystem &jobs, ExtensionInventory &inventory, std::string registryUrl);
