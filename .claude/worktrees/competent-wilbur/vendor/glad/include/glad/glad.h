 ...
 *
 * Committed to repository — do not regenerate unless targeting a different GL version.
 */
#ifndef __glad_h_
#define __glad_h_
...
/* Debug */
typedef void      (APIENTRYP PFNGLDEBUGMESSAGECALLBACKPROC)(void *callback, const void *userParam);
