...
bool VulkanRenderBackend::CreateDepthResources() {
  ...
  const VkImageCreateInfo depthImageInfo{
      ...
      .imageType = VK_IMAGE_TYPE_2D,
      .format = depthFormat,
      .extent = {m_context->swapchainExtent.width,
...
bool VulkanRenderBackend::RecordFrameCommands(const RenderFrameConfig &frame) {
  ...
  if (hasQueuedOpaqueDraws || hasQueuedOverlayRender) {
    ...
    const std::array<VkClearValue, 2> clearValues = {
        VkClearValue{.color = {{frame.clearColor.x, frame.clearColor.y,
    ...
    if (m_context->supportsDepthReadback &&
      ...
      const VkBufferImageCopy depthCopyRegion{
          ...
          .imageOffset = {0, 0, 0},
          .imageExtent = {m_context->swapchainExtent.width,
                          m_context->swapchainExtent.height, 1},
      };
    ...
    const VkClearColorValue clearColor = {
        {frame.clearColor.x, frame.clearColor.y, frame.clearColor.z,
         frame.clearColor.w}};
    const VkImageSubresourceRange clearRange{VK_IMAGE_ASPECT_COLOR_BIT, 0, 1, 0,
                                             1};
...
bool VulkanRenderBackend::TryGetImGuiVulkanInitData( // NOSONAR: cpp:S5008
                                                     // Vulkan init API is
                                                     // pointer-handle based
    void **, void **, void **, uint32_t *,
    void **, // NOSONAR: cpp:S5008 pointer-handle output parameters are required
             // by backend interface
    void **,
    uint32_t *) const { // NOSONAR: cpp:S5008 Vulkan API requires void* handles
  return false;
}

void *VulkanRenderBackend::GetActiveCommandBufferHandle()
    const { // NOSONAR: cpp:S5008 Vulkan API requires opaque pointer handles
  return nullptr;
}

void VulkanRenderBackend::
    QueueOverlayRenderCallback( // NOSONAR: cpp:S5817,cpp:S1238,cpp:S5213
                                // interface-fixed callback signature
        OverlayRenderCallback,  // NOSONAR: cpp:S1238,cpp:S5213 callback alias
                                // and parameter passing are fixed by the shared
                                // interface
        void *) { // NOSONAR: cpp:S5817,cpp:S1238,cpp:S5213,cpp:S5008 signature
                  // is fixed by shared backend interface
...
bool VulkanRenderBackend::
    EnsureOffscreenRenderTarget( // NOSONAR: cpp:S5817 interface requires
                                 // non-const mutating method
        const std::string &, uint32_t,
        uint32_t) { // NOSONAR: cpp:S5817 non-const to match mutable backend
                    // interface
  return false;
}

bool VulkanRenderBackend::
    TryGetOffscreenRenderTargetHandle( // NOSONAR: cpp:S5817 non-const to match
                                       // mutable backend interface
        const std::string &, RenderTargetHandle *,
        bool) { // NOSONAR: cpp:S5817 non-const to match mutable backend
                // interface
  return false;
}
...
void VulkanRenderBackend::DestroyOffscreenRenderTarget( // NOSONAR: cpp:S5817
                                                        // interface requires
                                                        // non-const mutating
                                                        // method
    const std::string
        &) { // NOSONAR: cpp:S5817 non-const to match mutable backend interface
             // Not implemented: Vulkan backend is a stub
}

void VulkanRenderBackend::
    DestroyAllOffscreenRenderTargets() { // NOSONAR: cpp:S5817 non-const to
                                         // match mutable backend interface
  // Not implemented: Vulkan backend is a stub
}

bool VulkanRenderBackend::Initialize( // NOSONAR: cpp:S5008,cpp:S5817 init
                                      // contract uses opaque handle and mutates
                                      // backend
    void *) { // NOSONAR: cpp:S5008,cpp:S5817 native pointer + mutating init
              // signature is fixed by interface
  return false;
}

void VulkanRenderBackend::Shutdown() { // NOSONAR: cpp:S5817 non-const to match
                                       // mutable backend interface
  // Not implemented: Vulkan backend is a stub
}

bool VulkanRenderBackend::RecreateSwapchain() { // NOSONAR: cpp:S5817 non-const
                                                // to match mutable backend
                                                // interface
  return false;
}

void VulkanRenderBackend::DestroySwapchain() { // NOSONAR: cpp:S5817 non-const
                                               // to match mutable backend
                                               // interface
  // Not implemented: Vulkan backend is a stub
}
...
bool VulkanRenderBackend::
    CreateOpaqueRasterScaffold() { // NOSONAR: cpp:S5817 non-const to match
                                   // mutable backend interface
  return false;
}

void VulkanRenderBackend::
    DestroyOpaqueRasterScaffold() { // NOSONAR: cpp:S5817 non-const to match
                                    // mutable backend interface
                                    // Not implemented: Vulkan backend is a stub
}

bool VulkanRenderBackend::
    CreateOpaquePipelineCreationScaffold() { // NOSONAR: cpp:S5817 non-const to
                                             // match mutable backend interface
  return false;
}

void VulkanRenderBackend::
    DestroyOpaquePipelineCreationScaffold() { // NOSONAR: cpp:S5817 non-const to
                                              // match mutable backend interface
  // Not implemented: Vulkan backend is a stub
}

bool VulkanRenderBackend::CreateDepthResources() { // NOSONAR: cpp:S5817
                                                   // non-const to match mutable
                                                   // backend interface
  return false;
}

void VulkanRenderBackend::DestroyDepthResources() { // NOSONAR: cpp:S5817
                                                    // non-const to match
                                                    // mutable backend interface
  // Not implemented: Vulkan backend is a stub
}

bool VulkanRenderBackend::EnsureReadbackBuffers() { // NOSONAR: cpp:S5817
                                                    // non-const to match
                                                    // mutable backend interface
  return false;
}
...
void VulkanRenderBackend::
    DestroyReadbackBuffers() { // NOSONAR: cpp:S5817 non-const to match mutable
                               // backend interface
                               // Not implemented: Vulkan backend is a stub
}

bool VulkanRenderBackend::
    CreateOpaqueMaterialBindingScaffold() { // NOSONAR: cpp:S5817 non-const to
                                            // match mutable backend interface
  return false;
}

void VulkanRenderBackend::
    DestroyOpaqueMaterialBindingScaffold() { // NOSONAR: cpp:S5817 non-const to
                                             // match mutable backend interface
  // Not implemented: Vulkan backend is a stub
}

bool VulkanRenderBackend::
    CreateOpaqueDrawIndexBuffer() { // NOSONAR: cpp:S5817 non-const to match
                                    // mutable backend interface
  return false;
}

void VulkanRenderBackend::
    DestroyOpaqueDrawIndexBuffer() { // NOSONAR: cpp:S5817 non-const to match
                                     // mutable backend interface
  // Not implemented: Vulkan backend is a stub
}

bool VulkanRenderBackend::EnsureOpaqueMeshGpuBuffers( // NOSONAR: cpp:S5817
                                                      // non-const to match
                                                      // mutable backend
                                                      // interface
    const Mesh
...
void VulkanRenderBackend::
    DestroyOpaqueMeshGpuBuffers() { // NOSONAR: cpp:S5817 non-const to match
                                    // mutable backend interface
                                    // Not implemented: Vulkan backend is a stub
}

bool VulkanRenderBackend::
    CreateOpaqueShaderPipelineScaffold() { // NOSONAR: cpp:S5817 non-const to
                                           // match mutable backend interface
  return false;
}

void VulkanRenderBackend::
    DestroyOpaqueShaderPipelineScaffold() { // NOSONAR: cpp:S5817 non-const to
                                            // match mutable backend interface
  // Not implemented: Vulkan backend is a stub
}

bool VulkanRenderBackend::
    GetOrCreateOpaquePipeline( // NOSONAR: cpp:S5817,cpp:S5008 mutable cache +
                               // opaque handle output is interface-defined
        const OpaquePipelineKey &,
        void **) { // NOSONAR: cpp:S5817,cpp:S5008 mutating pipeline cache API
                   // uses opaque handle pointer by contract
  return false;
}

bool VulkanRenderBackend::
    CreateOpaqueGraphicsPipelineScaffold() { // NOSONAR: cpp:S5817 non-const to
                                             // match mutable backend interface
  return false;
}

void VulkanRenderBackend::
    DestroyOpaqueGraphicsPipelineScaffold() { // NOSONAR: cpp:S5817 non-const to
                                              // match mutable backend interface
  // Not implemented: Vulkan backend is a stub
}

bool VulkanRenderBackend::RecordFrameCommands( // NOSONAR: cpp:S5817 non-const
                                               // to match mutable backend
                                               // interface
    const RenderFrameConfig
        &) { // NOSONAR: cpp:S5817 non-const to match mutable backend interface
  return false;
}

bool VulkanRenderBackend::
    EnsureOffscreenRenderPass() { // NOSONAR: cpp:S5817 non-const to match
                                  // mutable backend interface
  return false;
}

void VulkanRenderBackend::
    DestroyOffscreenRenderPass() { // NOSONAR: cpp:S5817 non-const to match
                                   // mutable backend interface
                                   // Not implemented: Vulkan backend is a stub
}

bool VulkanRenderBackend::
    CreateOffscreenRenderTargetResources( // NOSONAR: cpp:S5817 non-const to
                                          // match mutable backend interface
        const std::string &, uint32_t, uint32_t,
        uint64_t) { // NOSONAR: cpp:S5817 non-const to match mutable backend
                    // interface
  return false;
}

void VulkanRenderBackend::
    DestroyOffscreenRenderTargetResources( // NOSONAR: cpp:S5817 non-const to
                                           // match mutable backend interface
        const std::string &) { // NOSONAR: cpp:S5817 non-const to match mutable
                               // backend interface
                               // Not implemented: Vulkan backend is a stub
}

bool VulkanRenderBackend::
    TryRegisterOffscreenTargetImGuiDescriptor( // NOSONAR: cpp:S5817 non-const
                                               // to match mutable backend
                                               // interface
        const std::string &, RenderTargetHandle *,
        bool) { // NOSONAR: cpp:S5817 non-const to match mutable backend
