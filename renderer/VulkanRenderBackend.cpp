...
namespace Monolith
{
  ...
  bool VulkanRenderBackend::CreateOpaqueGraphicsPipelineScaffold()
  {
    ...
    {
      vkDestroyPipeline(m_context->device, m_context->opaqueGraphicsPipeline, nullptr);
    ...
    m_context->opaqueGraphicsPipelineExecutable = true;
    return true;
  }
  ...
  bool VulkanRenderBackend::RecordFrameCommands(const RenderFrameConfig &frame)
  {
    ...
    if (hasQueuedOpaqueDraws && hasExecutableOpaquePipeline)
    {
      ...
      const VkClearValue clearValue = {
          .color = {{frame.clearColor.x, frame.clearColor.y, frame.clearColor.z, frame.clearColor.w}}};
