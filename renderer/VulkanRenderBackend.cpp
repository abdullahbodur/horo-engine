...
namespace Horo {
    ...
    bool VulkanRenderBackend::TryGetImGuiVulkanInitData( // NOSONAR: cpp:S5008
        ...
        void **,
        uint32_t *) const {
        // NOSONAR: cpp:S5008 Vulkan API requires void* handles
        return false;
    }

    void *VulkanRenderBackend::GetActiveCommandBufferHandle()
    const {
        // NOSONAR: cpp:S5008 Vulkan API requires opaque pointer handles
        return nullptr;
    }
    ...
    QueueOverlayRenderCallback( // NOSONAR: cpp:S5817,cpp:S1238,cpp:S5213
        ...
        // interface
        void *) {
        // NOSONAR: cpp:S5817,cpp:S1238,cpp:S5213,cpp:S5008 signature
    ...
    EnsureOffscreenRenderTarget( // NOSONAR: cpp:S5817 interface requires
        ...
        uint32_t) {
        // NOSONAR: cpp:S5817 non-const to match mutable backend
        // interface
        return false;
    }
    ...
    void VulkanRenderBackend::
    DestroyAllOffscreenRenderTargets() {
        // NOSONAR: cpp:S5817 non-const to
    ...
    bool VulkanRenderBackend::Initialize( // NOSONAR: cpp:S5008,cpp:S5817 init
        ...
        // backend
        void *) {
        // NOSONAR: cpp:S5008,cpp:S5817 native pointer + mutating init
        // signature is fixed by interface
        return false;
    }

    void VulkanRenderBackend::Shutdown() {
        // NOSONAR: cpp:S5817 non-const to match
        // mutable backend interface
        // Not implemented: Vulkan backend is a stub
    }

    bool VulkanRenderBackend::RecreateSwapchain() {
        // NOSONAR: cpp:S5817 non-const
    ...
    bool VulkanRenderBackend::
    CreateOpaquePipelineCreationScaffold() {
        // NOSONAR: cpp:S5817 non-const to
        // match mutable backend interface
        return false;
    }
    ...
    void VulkanRenderBackend::
    DestroyReadbackBuffers() {
        // NOSONAR: cpp:S5817 non-const to match mutable
        // backend interface
        // Not implemented: Vulkan backend is a stub
    }

    bool VulkanRenderBackend::
    CreateOpaqueMaterialBindingScaffold() {
        // NOSONAR: cpp:S5817 non-const to
        // match mutable backend interface
        return false;
    }
    ...
    bool VulkanRenderBackend::
    CreateOpaqueShaderPipelineScaffold() {
        // NOSONAR: cpp:S5817 non-const to
        // match mutable backend interface
        return false;
    }
    ...
    GetOrCreateOpaquePipeline( // NOSONAR: cpp:S5817,cpp:S5008 mutable cache +
        ...
        void **) {
        // NOSONAR: cpp:S5817,cpp:S5008 mutating pipeline cache API
