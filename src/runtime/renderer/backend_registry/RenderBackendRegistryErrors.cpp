...
namespace Horo::Render::RegistryErrors {
    ...
    const ErrorCodeDescriptor BackendNotFound{.domain = Domain,
    ...
    const ErrorCodeDescriptor DuplicateBackend{.domain = Domain,
    ...
    const ErrorCodeDescriptor NotSealed{.domain = Domain,
    ...
    const ErrorCodeDescriptor ProviderException{.domain = Domain,
    ...
    const ErrorCodeDescriptor ProviderReturnedNull{.domain = Domain,
    ...
    const ErrorCodeDescriptor Sealed{.domain = Domain,
