...
namespace Horo::Runtime::PrimitiveErrors {
    ...
    const ErrorCodeDescriptor CacheCapacityExceeded{.domain = Domain,
                                                    .code = ErrorCode{"primitive.cache_capacity_exceeded"},
                                                    .defaultSeverity = ErrorSeverity::Error,
                                                    .summary = "Primitive mesh cache capacity was exceeded.",
                                                    .remediationHint =
                                                        "Release active mesh leases or increase the configured cache budget.",
                                                    .retryable = true,
    ...
    const ErrorCodeDescriptor InvalidCapsuleHeight{.domain = Domain,
    ...
    const ErrorCodeDescriptor InvalidDimensions{.domain = Domain,
    ...
    const ErrorCodeDescriptor InvalidGeneratedMesh{.domain = Domain,
    ...
    const ErrorCodeDescriptor InvalidRadius{.domain = Domain,
    ...
    const ErrorCodeDescriptor InvalidSize{.domain = Domain,
    ...
    const ErrorCodeDescriptor InvalidTessellation{.domain = Domain,
    ...
    const ErrorCodeDescriptor ParameterMismatch{.domain = Domain,
