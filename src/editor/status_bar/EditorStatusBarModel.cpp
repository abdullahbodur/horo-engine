...
namespace Horo::Editor {
    ...
    std::vector<const EditorStatusItem *> EditorStatusItemRegistry::VisibleItems(const EditorStatusBarContext &context) const {
    ...
    EditorStatusBarLayout PlanEditorStatusBarLayout(const std::span<const EditorStatusMeasuredItem> measured, const float availableWidth,
        ...
        PlanEditorStatusBarLayoutInto(measured, availableWidth, itemGap, overflowWidth, maxVisibleItems, rankedScratch, result);
        return result;
    }
