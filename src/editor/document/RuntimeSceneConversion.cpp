                                                                      ...
                                                                      const Runtime::SceneDefinitionId sceneId)
{
    ...
    {
        Runtime::RuntimeComponentSet components{object.components.camera, object.components.light,
        ...
        builder.Add(Runtime::RuntimeEntityDefinition{
            ...
            object.parent ? std::optional<Runtime::SceneObjectId>{Runtime::SceneObjectId{object.parent->value}}
                          : std::nullopt,
