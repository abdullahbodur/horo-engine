...
namespace Horo::Editor {
    ...
    namespace ViewportSceneErrors {
        const ErrorCodeDescriptor HierarchyCycle{.domain = ViewportSceneDomain,
        ...
        const ErrorCodeDescriptor InstanceIdentityMismatch{.domain = ViewportSceneDomain,
        ...
        const ErrorCodeDescriptor InvalidCamera{.domain = ViewportSceneDomain,
        ...
        const ErrorCodeDescriptor InvalidObjectId{.domain = ViewportSceneDomain,
        ...
        const ErrorCodeDescriptor InvalidResult{.domain = ViewportSceneDomain,
        ...
        const ErrorCodeDescriptor ObjectNotFound{.domain = ViewportSceneDomain,
        ...
        const ErrorCodeDescriptor ParentNotFound{.domain = ViewportSceneDomain,
    ...
    namespace ViewportPickingErrors {
        const ErrorCodeDescriptor InvalidIdentity{.domain = ViewportPickingDomain,
        ...
        const ErrorCodeDescriptor InvalidQuery{.domain = ViewportPickingDomain,
        ...
        const ErrorCodeDescriptor InvalidScene{.domain = ViewportPickingDomain,
