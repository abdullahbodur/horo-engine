...
namespace Horo::Editor
{
                                              ...
                                              const RendererAvailabilitySnapshot& availability)
    {
        ...
        if (!IsCompatible(compatibility.status))
        {
            ...
            return ProjectOpenPreflight{
                .status = unreadable
                              ? ProjectOpenPreflightStatus::ProjectMetadataUnreadable
        ...
        {
            return ProjectOpenPreflight{
                .status = ProjectOpenPreflightStatus::ProjectMetadataUnreadable,
        ...
        {
            return ProjectOpenPreflight{
                .status = ProjectOpenPreflightStatus::RendererNotInstalled,
        ...
        {
            return ProjectOpenPreflight{
                .status = ProjectOpenPreflightStatus::RendererRepairRequired,
                .requiredBackendId = metadata.renderBackend,
                .projectName = metadata.name,
        ...
        {
            return ProjectOpenPreflight{
                .status = ProjectOpenPreflightStatus::RendererUpdateRequired,
                .requiredBackendId = metadata.renderBackend,
                .projectName = metadata.name,
                .diagnostic = backend->diagnostic
            };
        ...
        {
            return ProjectOpenPreflight{
                .status = ProjectOpenPreflightStatus::RendererCapabilityMismatch,
                .requiredBackendId = metadata.renderBackend,
                .projectName = metadata.name,
                .diagnostic = backend->diagnostic
            };
        ...
        if (!backend->IsSelectable())
        {
            ...
            return ProjectOpenPreflight{
                .status = ProjectOpenPreflightStatus::RendererUnavailable,
                .requiredBackendId = metadata.renderBackend,
                .projectName = metadata.name,
        ...
        {
            return ProjectOpenPreflight{
                .status = ProjectOpenPreflightStatus::RequiresRendererRestart,
                .requiredBackendId = metadata.renderBackend,
                .projectName = metadata.name
            };
        }
        return ProjectOpenPreflight{
            .status = ProjectOpenPreflightStatus::Ready,
            .requiredBackendId = metadata.renderBackend,
            .projectName = metadata.name
        };
    }
