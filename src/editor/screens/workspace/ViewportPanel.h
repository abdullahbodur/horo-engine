...
namespace Horo::Editor {
    ...
    public:
        [[nodiscard]] std::string GetId() const override { return "horo.viewport"; }
        [[nodiscard]] std::string GetDisplayName() const override { return "horo.panel.viewport.title"; }
        [[nodiscard]] WorkspaceDockArea GetDefaultDockArea() const override { return WorkspaceDockArea::Document; }
