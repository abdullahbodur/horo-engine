...
{
public:
    [[nodiscard]] std::string GetId() const override { return "horo.content_browser"; }
    [[nodiscard]] std::string GetDisplayName() const override { return "horo.panel.content_browser.title"; }
    [[nodiscard]] WorkspaceDockArea GetDefaultDockArea() const override { return WorkspaceDockArea::Bottom; }
