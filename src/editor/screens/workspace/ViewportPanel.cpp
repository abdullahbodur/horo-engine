...
{
    const std::vector tabNames = {"Viewport"};
    ...
    dl->AddRectFilledMultiColor(
        ...
        ImGui::GetColorU32(ImVec4(0.05F, 0.06F, 0.09F, 1.0F)), ImGui::GetColorU32(ImVec4(0.09F, 0.11F, 0.15F, 1.0F)),
    ...
    dl->AddRectFilledMultiColor(
        ...
        ImGui::GetColorU32(ImVec4(0.01F, 0.22F, 0.44F, 0.0F)), ImGui::GetColorU32(ImVec4(0.01F, 0.22F, 0.44F, 0.0F)),
        ImGui::GetColorU32(ImVec4(0.03F, 0.38F, 0.60F, 0.35F)), ImGui::GetColorU32(ImVec4(0.03F, 0.38F, 0.60F, 0.35F)));
