...
{
    const std::array tabNames{ctx.localization.Get("editor", "workspace.panel.content_browser").c_str()};
    ...
    ImGui::TextUnformatted(ctx.localization.Get("editor", "workspace.content_browser.assets_root").c_str());
    ImGui::PopStyleColor();
    ...
    const std::array dirs = {
        ctx.localization.Get("editor", "workspace.content_browser.scenes").c_str(),
        ctx.localization.Get("editor", "workspace.content_browser.models").c_str(),
        ctx.localization.Get("editor", "workspace.content_browser.textures").c_str(),
        ctx.localization.Get("editor", "workspace.content_browser.materials").c_str(),
        ctx.localization.Get("editor", "workspace.content_browser.shaders").c_str(),
        ctx.localization.Get("editor", "workspace.content_browser.audio").c_str()};
