...
namespace Horo::Tests {
    ...
    struct EditorUiScenarioBudget {
        ...
        /** @brief Creates an explicitly justified extended budget, capped at 6000 frames. */
    ...
    public:
        ...
        [[nodiscard]] EditorUiScenarioResult Run(std::string category, std::string name, GuiFunction gui, TestFunction test,
        ...
        [[nodiscard]] EditorUiScenarioResult RunScenario(std::string category, std::string name, GuiFunction gui, ScenarioFunction scenario,
                                                         EditorUiScenarioBudget budget = EditorUiScenarioBudget::Default(),
                                                         Input::InputRouter *router = nullptr);
    ...
    private:
        ...
        [[nodiscard]] EditorUiScenarioResult RunInternal(std::string category, std::string name, GuiFunction gui, InternalTestFunction test,
                                                         EditorUiScenarioBudget budget, Input::InputRouter *router);
