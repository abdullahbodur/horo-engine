...
namespace Horo::Destruction {
    ...
    TEST_CASE("Destruction identity errors are stable and unique", "[unit][destruction][identity]") {
        const std::array errors{DestructionErrors::IdentityInvalid,
                                ...
                                DestructionErrors::GenerationExhausted,
                                DestructionErrors::RevisionExhausted,
                                DestructionErrors::SerializedIdentityInvalid,
                                DestructionErrors::DescriptorInvalid,
                                DestructionErrors::TierInvalid,
                                DestructionErrors::FeatureUnsatisfied,
                                DestructionErrors::RuntimeGeometryUnsupported,
                                DestructionErrors::LimitProfileInvalid,
                                DestructionErrors::LimitExceeded,
                                DestructionErrors::StaleConfiguration,
                                DestructionErrors::StateInvalid,
                                DestructionErrors::InvalidDamage,
                                DestructionErrors::DuplicateCommand,
                                DestructionErrors::StateTerminal,
                                ...
                                DestructionErrors::RegistryDuplicate,
