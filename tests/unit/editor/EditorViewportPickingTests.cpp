...
namespace {
    ...
    TEST_CASE("Identity Mapping Mismatch Is Rejected", "[unit][editor]") {
        ...
        EditorViewportSceneSnapshot scene{
            ...
            .camera = {},
            .meshLeases = {lease},
            .meshResources = {{Render::RenderMeshSourceHandle{lease.Id(), 1}, mesh.vertices, mesh.indices, mesh.localBounds}},
            .instances = {EditorViewportInstance{Render::RenderMeshSourceHandle{lease.Id(), 1},
                                                 Math::Mat4::Identity(),
                                                 mesh.localBounds,
