    ...
    TEST_CASE("Viewport Scene Validates Typed Inputs And Shared Geometry", "[unit][editor]")
    {
        ...
        const std::array instances{
            EditorViewportInstance{
                meshHandle, Math::Mat4::Identity(), mesh.localBounds, Render::CoreDefaultMaterial, {}
            }
        };
        ...
        const EditorViewportSceneView invalid{
            .camera = invalidCamera, .meshResources = resources, .instances = instances
        };
