...
namespace Monolith {
    ...
    struct SceneSettings {
        ...
        std::unordered_map<std::string, std::string, StringHash, std::equal_to<> > extraSettings;
    };
    ...
    struct SceneCameraProperties {
        ...
        std::unordered_map<std::string, std::string, StringHash, std::equal_to<> > extraProps;
    };
