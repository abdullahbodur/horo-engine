...
namespace Monolith {
    namespace {
        ...
        void AttachBehaviorIfPresent(Scene *scene, const RuntimeSceneProp &prop,
                                     const SceneReferenceRuntime::BehaviorFactory &
                                     behaviorFactory,
    ...
    bool SceneReferenceRuntime::ApplyRuntimeDefinition(
        ...
        for (const auto &room: definition.rooms) {
            ...
            for (const auto &prop: room.props) {
                ...
                AttachBehaviorIfPresent(m_scene, prop, m_behaviorFactory, entity,
                                        &m_stats);
