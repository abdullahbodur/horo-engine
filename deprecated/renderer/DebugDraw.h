...
namespace Horo {
    ...
    public:
        ...
        // Queue a filled sphere (composed of triangles, double-sided via Triangle()).
        static void SolidSphere(const Vec3 &center, float radius,
                                const Vec4 &color = {0, 1, 0, 1}, int segs = 16);
