    ...
    namespace {
        ...
        const std::vector<McpCatalogEntry> &GetToolCatalog() {
            static const std::vector<McpCatalogEntry> catalog = {
                ...
                {"editor.reload_scene", "tool", "Queue an in-editor scene reload."},
                {
                    ...
                    "Start an asynchronous release build for a project."
                },
                {
                    "editor.release_project", "tool",
                    "Start an asynchronous release build for the open editor project."
                },
        ...
        json BuildInitializeResult() {
            return json{
                ...
                {"serverInfo", {{"name", "horo-engine"}, {"version", std::string(Horo::Build::EngineVersion())}}},
                {
                    "capabilities",
                    {
        ...
        bool IsWriteToolName(std::string_view name) {
            static const std::unordered_set<std::string, StringHash, std::equal_to<> >
                    kWriteTools = {
                        ...
                        "project.release", "editor.release_project",
                    };
