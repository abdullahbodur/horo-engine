...
namespace Horo::Mcp {
        struct McpHttpRequest {
            std::string method;
            std::string path;
            std::unordered_map<std::string, std::string, StringHash, std::equal_to<>> headers;
            std::string body;
        };
        ...
        private:
            ...
            mutable std::unordered_map<std::string, PreviewRecord, StringHash, std::equal_to<>> m_previewRecords;
        };
} // namespace Horo::Mcp
