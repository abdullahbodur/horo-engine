...
def clean_junit_output_dir(outdir: str) -> None:
    """Remove stale scenario reports before generating a fresh JUnit set."""
    output_path = Path(outdir)
    output_path.mkdir(parents=True, exist_ok=True)
    for xml_path in output_path.glob("*.xml"):
        xml_path.unlink()
