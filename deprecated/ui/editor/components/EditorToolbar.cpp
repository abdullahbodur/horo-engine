...
/** @copydoc EditorToolbar::DrawBuildMenu */
void EditorToolbar::DrawBuildMenu(const EditorToolbarCallbacks& callbacks) const {
    if (!ImGui::BeginMenu("Build"))
        return;

    if (ImGui::MenuItem("Build & Release...") && callbacks.openBuildPipeline)
        callbacks.openBuildPipeline();
