...
namespace Horo::Editor {
    ...
    struct EditorToolbarCallbacks {
        ...
        std::function<void()> openBuildPipeline;                   /**< Open the Build & Release pipeline modal. */
    ...
    private:
        ...
        /** @brief Draws the Build drop-down menu.
         *  @param callbacks Editor action callbacks. */
        void DrawBuildMenu(const EditorToolbarCallbacks& callbacks) const;
