...
namespace Horo::Editor {
    ...
    public:
        ...
        /**
         * @brief Loads a SceneDocument from an in-memory JSON string.
         * @param jsonText Raw scene JSON text.
         * @param sourceName Human-readable source name used in diagnostics.
         * @return The deserialized SceneDocument.
         * @throws SceneSerializerException if the JSON is invalid.
         */
        static SceneDocument LoadFromString(const std::string &jsonText,
