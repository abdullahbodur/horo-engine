...
namespace Monolith {
    ...
    namespace Editor {
        ...
        private:
            ...
            void ApplyGizmoTranslateSnapping(GizmoAxis dragAxis, int primIdx,
                                             Vec3 &dPos);
            ...
            void DrawAssetTile(const std::string &assetId, const AssetDef &asset,
                               float tileW, float tileH, float thumbPad,
                               float thumbSize);
            ...
            std::unordered_set<std::string, StringHash, std::equal_to<> > m_projectExtraBlocklist;
            ...
            std::unordered_map<std::string, ProjectDirCache, StringHash, std::equal_to<> > m_projectDirCache;
            ...
            Mcp::McpCommandResult McpHandleCreateObjectFromAsset(const nlohmann::json &arguments);
            ...
            Mcp::McpCommandResult McpHandleReparentObject(const nlohmann::json &arguments);
