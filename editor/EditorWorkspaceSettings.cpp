...
namespace Monolith::Editor {
    ...
    EditorWorkspaceDocument LoadEditorWorkspaceDocument() {
        ...
        out.state.consoleShowInfo =
                editorJson.value("consoleShowInfo", out.state.consoleShowInfo);
        out.state.consoleShowWarn =
                editorJson.value("consoleShowWarn", out.state.consoleShowWarn);
        out.state.consoleShowError =
                editorJson.value("consoleShowError", out.state.consoleShowError);
        out.state.projectBrowserCwd =
                editorJson.value("projectBrowserCwd", out.state.projectBrowserCwd);
        return out;
    }
