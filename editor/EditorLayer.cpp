...
namespace Monolith::Editor {
    ...
    void EditorLayer::HandleEditorKeyboardShortcuts(
        const Camera &cam) {
        // NOSONAR: cpp:S3776 multi-shortcut dispatch; each
    ...
    void EditorLayer::DrawViewGimbal(
        const Camera
        &cam) {
        // NOSONAR: cpp:S3776 complex axis gimbal with sort, hover, and
        ...
        const ViewSnap hoverSnap =
                canvasHovered
                    ? FindViewGimbalHoverSnap(io.MousePos, center, cache, kAxes,
                                              kShaftPx, kHitPxSq)
                    : None;
    ...
    void EditorLayer::DrawCreateAssetModalContent() {
        ...
        if (ImGui::Button("Create Asset", ImVec2(150.0f, 0.0f))) {
            ...
            def.displayName = m_assetDraftDisplayName.empty()
                                  ? m_assetDraftId
                                  : m_assetDraftDisplayName;
