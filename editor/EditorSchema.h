...
namespace Monolith::Editor {
    ...
    public:
        ...
        const std::unordered_map<std::string, TypeSchema, StringHash,
            std::equal_to<> > &TypeSchemas() const {
            return m_schemas;
        }
    ...
    private:
        std::unordered_map<std::string, TypeSchema, StringHash, std::equal_to<> > m_schemas;
        std::unordered_map<std::string, ComponentSchema, StringHash, std::equal_to<> > m_componentSchemas;
    };
} // namespace Monolith::Editor
