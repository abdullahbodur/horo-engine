...
constexpr HoroPalette kPalette{
    ...
    .panel = ImVec4(0.05f, 0.09f, 0.15f, 1.0f),
    .panelSoft = ImVec4(0.07f, 0.11f, 0.18f, 1.0f),
    .card = ImVec4(0.05f, 0.10f, 0.17f, 1.0f),
    .cardHover = ImVec4(0.08f, 0.15f, 0.25f, 1.0f),
    .border = ImVec4(0.16f, 0.27f, 0.42f, 1.0f),
...
constexpr HoroPalette kGraphitePalette{
    ...
    .panel = ImVec4(0.12f, 0.12f, 0.14f, 1.0f),
    .panelSoft = ImVec4(0.15f, 0.15f, 0.17f, 1.0f),
    .card = ImVec4(0.10f, 0.10f, 0.12f, 1.0f),
    .cardHover = ImVec4(0.18f, 0.18f, 0.21f, 1.0f),
    .border = ImVec4(0.30f, 0.32f, 0.36f, 1.0f),
...
constexpr HoroPalette kHighContrastPalette{
    ...
    .panel = ImVec4(0.02f, 0.02f, 0.03f, 1.0f),
    .panelSoft = ImVec4(0.06f, 0.06f, 0.07f, 1.0f),
    .card = ImVec4(0.03f, 0.03f, 0.04f, 1.0f),
    .cardHover = ImVec4(0.12f, 0.14f, 0.18f, 1.0f),
